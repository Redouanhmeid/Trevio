...
const corsOptions = {
 origin: function (origin, callback) {
  const allowedOrigins = ['https://conciergestay.pro'];
...
const options = {
 key: fs.readFileSync('/etc/letsencrypt/live/conciergestay.pro/privkey.pem'),
 cert: fs.readFileSync('/etc/letsencrypt/live/conciergestay.pro/fullchain.pem'),
};
